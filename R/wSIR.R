...
#' @param optim_params logical default FALSE. If you would like wSIR to automatically optimise parameters slices and alpha based on
#' either distance correlation or correlation of distances as evaluation metric. If your downstream
...
#' @param verbose logical (default FALSE) whether progress messages should be printed
