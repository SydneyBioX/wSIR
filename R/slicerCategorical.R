...
#'
#' @description
#' This function averages all columns in the X matrix for each category in the single-column Y dataframe. It
#' is used to find the average position within each tile to create the weight matrix, as well as to create the
...
#' @param Y dataframe with a single column named 'coordinate'. This column contains the categorical variable
