...
#' @param Y dataframe with a single column named 'coordinate'. This column contains the categorical variable tile ID for each cell. 
#'
#' @return dataframe containing the averages for each column within each category in Y. Dimension h * p, where h is the number of categories in Y and p is the number of columns in X.
#'
#' @keywords internal
