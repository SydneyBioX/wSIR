...
#' This function plots
#' each cell at its true spatial coordinates, coloured by their values for
#' WSIR1 / WSIR2 / ... .
#' The plots give an intuition about what biological signals are contained in
#' the WSIR directions.
#'
...
#' @param dirs integer for how many of the low-dimensional directions you
#' would like to visualise. Recommend no more
#' than 10 for ease of visualisation. Default is 6.
#' @param mincol String for the colour of low values of low-dimensional
#' directions. Personal choice for user, default is "blue".
#' @param maxcol String for the colour of high values of low-dimensional
#' directions. Personal choice for user, default is "red".
#'
#' @return Grid of plots with dirs number of plots. Each shows the cells at
