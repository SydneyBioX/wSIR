...
#' be no more than around \sqrt{n/20}, as this upper bound ensures an average of at least 10 cells per tile in the training set. 
#' @param varThreshold numeric proportion of variance in t(X_H) %*% W %*% X_H to retain. Must be between 0 and 1. Default is 0.95. 
