...
Note: there is a BioConductor limit on the size of data that can be used for examples and vignettes. To stay under that, we randomly sample half of the cells from the two samples.
