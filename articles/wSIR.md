...
can see that SIR’s performance deteriorates as you use larger values for
...
utilise the resulting plot to identify a larger subset of the genes that
contribute to wSIR’s spatially-informed low dimensional embedding.
